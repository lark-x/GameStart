...
private readonly client: SqlClient;
  ...
  public constructor(client: SqlClient) {
    ...
    this.memories = {
      getById: async (id) => {
        const result = await this.client.query(`${MEMORY_SELECT} WHERE id = $1`, [id]);
        const row = result.rows[0];
    ...
    this.storyArcs = {
      ...
      getById: async (id) => {
        const result = await this.client.query(`${STORY_ARC_SELECT} WHERE id = $1`, [id]);
        const row = result.rows[0];
      ...
      delete: async (id) => {
        await this.client.query(`DELETE FROM story_arcs WHERE id = $1`, [id]);
      },
    };
    ...
    this.storyNodes = {
      ...
      getById: async (id) => {
        const result = await this.client.query(`${STORY_NODE_SELECT} WHERE id = $1`, [id]);
        const row = result.rows[0];
      ...
      delete: async (id) => {
        await this.client.query(`DELETE FROM story_nodes WHERE id = $1`, [id]);
      },
    };
    ...
    this.storyEdges = {
      ...
      getById: async (id) => {
        const result = await this.client.query(`${STORY_EDGE_SELECT} WHERE id = $1`, [id]);
        const row = result.rows[0];
      ...
      delete: async (id) => {
        await this.client.query(`DELETE FROM story_edges WHERE id = $1`, [id]);
      },
    };
    ...
    this.promptTemplates = {
      ...
      getById: async (id) => {
        const result = await this.client.query(`${PROMPT_TEMPLATE_SELECT} WHERE id = $1`, [id]);
        const row = result.rows[0];
      ...
      delete: async (id) => {
        await this.client.query(`DELETE FROM prompt_templates WHERE id = $1`, [id]);
      },
    };
    ...
    this.memoryCandidates = {
      ...
      getById: async (id) => {
        const result = await this.client.query(`${MEMORY_CANDIDATE_SELECT} WHERE id = $1`, [id]);
        const row = result.rows[0];
